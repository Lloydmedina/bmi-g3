...
class PushupTimer extends StatefulWidget {
  const PushupTimer({Key? key}) : super(key: key);

  @override
  _PushupTimerState createState() => _PushupTimerState();
}

class _PushupTimerState extends State<PushupTimer>
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Push Up Excercise'),
        ),
